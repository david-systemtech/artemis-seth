...
A served conversation reaches the skills installed on the server, a remote pane's `/` menu lists them, and a delegated task in a served conversation can be stopped.
